  ...
  <el-dialog title="生产信息" 
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="基本信息" name="1">
        <el-form ref="form" :model="ProductionInfoMapPo" label-width="130px" :inline="true">
          <el-form-item label="合同签订日期">
            <el-input v-model="ProductionInfoMapPo.orderCreationtime" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="预计交货天数">
	  ...
	  <!--  -->
	  <el-tab-pane label="工艺审核" name="2">
	    <el-table :data="ProductionInfoMapPo.omgTechnicsBPoList" style="width: 100%">
	      <el-table-column prop="fileName" label="文件名称" width="220"></el-table-column>
	      <el-table-column prop="fileType" label="文件类型" width="180"></el-table-column>
		  <el-table-column prop="state" label="工艺审核状态" width="180" :formatter="stateFormat"></el-table-column>
	    </el-table>
	  </el-tab-pane>
	  <!--  -->
	  
      <el-tab-pane label="生产计划" name="3">
	 ...
	 <!--  -->
	 <el-tab-pane label="库房备料 " name="4">
	   <el-table :data="ProductionInfoMapPo.omgMaterielWareHuosePo" style="width: 100%">
	     <el-table-column prop="fileName" label="文件名字" width="180"></el-table-column>
		 <el-table-column prop="billState" label="状态" width="180" :formatter="stateFormat1"></el-table-column>
	   </el-table>
	 </el-tab-pane>
	 <el-tab-pane label="物料采购 " name="5">
	   <el-table :data="ProductionInfoMapPo.omgMaterielPurchasePo" style="width: 100%">
	     <el-table-column prop="estimatedOverTime" label="预计齐料时间 " width="180"></el-table-column>
	     <el-table-column prop="costUnitPriceNt" label="成本单价(未税)" width="180"></el-table-column>
	     <el-table-column prop="finishAmountNt" label="成品金额(未税)" width="180"></el-table-column>
	     <el-table-column prop="priceTaxTotal " label="价税合计" width="180"></el-table-column>
		 ...
		 <el-table-column prop="billState" label="状态"  :formatter="stateFormat1" width="180"></el-table-column>
	   </el-table>
	 </el-tab-pane>
	 <el-tab-pane label="来料质检 " name="6">
	   <el-table :data="ProductionInfoMapPo.omgMaterielQualityPo" style="width: 100%">
	    <el-table-column prop="memo" label="说明" width="180"></el-table-column>
	    <el-table-column prop="chargeTime" label="经办时间" width="180"></el-table-column>
	    <el-table-column prop="qualityNum" label="质检数量" width="180"></el-table-column>
	    <el-table-column prop="chargePsnShow" label="经办人" width="180"></el-table-column>
	    <el-table-column prop="billState" label="状态"  :formatter="stateFormat1" width="180"></el-table-column>
	   </el-table>
	 </el-tab-pane>
      <el-tab-pane label="物料入库" name="7">
        <el-table :data="ProductionInfoMapPo.omgMaterielPutinWareBPoList" style="width: 100%">
          ...
          <el-table-column prop="overTime" label="齐料时间" width="180"></el-table-column>
          <el-table-column prop="chargeTime" label="经办时间" width="180"></el-table-column>
          <el-table-column prop="PutinWareName" label="经办人"></el-table-column>
		  <el-table-column prop="billState" label="状态"  :formatter="stateFormat1" width="180"></el-table-column>
        </el-table>
      </el-tab-pane>
      <el-tab-pane label="SMT" name="8">
	  ...
	  <el-tab-pane label="成品质检 " name="10">
	    <el-table :data="ProductionInfoMapPo.omgBecomeBPoList" style="width: 100%">
	     <el-table-column prop="procedureName" label="工序名称 " width="180"></el-table-column>
	     <el-table-column prop="sequenceNum" label="序列号段" width="180"></el-table-column>
	     <el-table-column prop="checkNum" label="检查数量" width="180"></el-table-column>
	     <el-table-column prop="passNum" label="通过数量" width="180"></el-table-column>
	     <el-table-column prop="passRate" label="合格率"></el-table-column>
	     <el-table-column prop="chargeTime" label="经办时间"></el-table-column>
	     <el-table-column prop="chargePsnShow" label="经办人"></el-table-column>
	     <el-table-column prop="billState" label="状态"  :formatter="stateFormat1" width="180"></el-table-column>
	    </el-table>
	  </el-tab-pane>
      <el-tab-pane label="成品出库" name="11">
        <el-table :data="ProductionInfoMapPo.omgPrduFinishPutoutBPoList" style="width: 100%">
		  <el-table-column prop="procedureName" label="工序类型" width="180"></el-table-column>
		  <el-table-column prop="putinNum" label="入库数量" width="180"></el-table-column>
		  <el-table-column prop="chargePsnShow" label="经办人"></el-table-column>
		  <el-table-column prop="chargeTime" label="经办时间"></el-table-column>
		  <el-table-column prop="billState" label="状态"  :formatter="stateFormat1" width="180"></el-table-column>
        </el-table>
      </el-tab-pane>
      <el-tab-pane label="通知开票" name="12">
  ...
  data() {
    return {
      ...
      ProductionInfoMapPo: {
	    ...
	    omgMaterielQualityPo:[],  // 来料质检
		omgOrderPlanBPoList:[],   //生产计划
		omgTechnicsBPoList:[],   //工艺审核
		omgMaterielWareHuosePo:[], //库房备料
		omgMaterielPurchasePo:[], //物料采购i
		omgBecomeBPoList:[],   //成品质检
		omgPrduFinishPutinPoList:[], //成品入库
		omgMaterielPutinWareBPoList:[],  //物料入库
		omgPrduFinishPutoutBPoList:[]  //成品出库
      }, // 生产流程详情PO
