<template>
  ...
  >
    ...
    >
      ...
      <el-tabs type="border-card">
        <el-tab-pane label="收货地址">
          <div v-for="(item, key) in takeOverList" :key="key">
            <el-radio
              v-model="temp.pkTakeover"
              :label="item.pkTakeover"
              border
      ...
      <el-tabs type="border-card">
        <el-button-group>
          <el-button icon="el-icon-circle-plus" @click="subBtnClick('ADD')"
            >新增</el-button
          >
        </el-button-group>
        <hr />
    ...
    >
      <el-tabs type="border-card">
        <el-button icon="el-icon-circle-plus" @click="addNewMateriel()"
          >新增</el-button
        >
        ...
        <el-tab-pane label="物料信息">
          <el-table :data="materielList" border style="width: 100%">
            ...
            <el-table-column label="操作" width="200">
              <template slot-scope="scope">
                <el-button
                  @click="deleteSubMaterielRow(scope.$index, scope.row)"
                  type="text"
                  size="small"
                  >移除</el-button
                >
...
export default {
  ...
  methods: {
    ...
    deleteSubMaterielRow(index, row) {
      // 删除物料数据
