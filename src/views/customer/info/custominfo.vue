<template>
  <div class="app-container">
    <split-pane split="vertical" :min-percent='15' :default-percent='18' @resize="resize">
      <template slot="paneL">
        ...
        <el-tabs tab-position="top" style="height: 200px;">
          ...
          <el-tab-pane label="收货信息">
            ...
            <el-table :data="bdTakeoverPoList" style="width: 100%">
              ...
              <el-table-column prop="takeoverPsnShow" label="收货人" width="180"></el-table-column>
          ...
          <el-tab-pane label="开票信息">
            ...
            <el-form :inline="true" ref="dataForm" :model="bdInvoicePo" label-position="left" label-width="150px">
              <el-form-item label="开票公司名称" prop="corpname">
                <el-input v-model="bdInvoicePo.corpname" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="税号" prop="dutynum">
                <el-input v-model="bdInvoicePo.dutynum"  :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="电话" prop="invoiceTel">
                <el-input v-model="bdInvoicePo.invoiceTel" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="开户行" prop="invoiceBank">
                <el-input v-model="bdInvoicePo.invoiceBank" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="账号" prop="invoiceAccount">
                <el-input v-model="bdInvoicePo.invoiceAccount" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="地址" prop="invoiceAddress">
                <el-input v-model="bdInvoicePo.invoiceAddress"  :disabled="true" style="width:580px"></el-input>
              </el-form-item>
            </el-form>
            ...
            <el-form :inline="true" ref="dataForm" :model="bdInvoicePo" label-position="left" label-width="150px">
              <el-form-item label="发票收件人" prop="addressee">
                <el-input v-model="bdInvoicePo.addressee" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="发票收件人电话" prop="addresseeTel">
                <el-input v-model="bdInvoicePo.addresseeTel" :disabled="true"></el-input>
              </el-form-item>
              <el-form-item label="发票收件人地址" prop="addresseeAdrs">
                <el-input v-model="bdInvoicePo.addresseeAdrs" :disabled="true" style="width:580px"></el-input>
              </el-form-item>
            </el-form>
          ...
          <el-tab-pane label="联系人">
            <!-- <el-button type="primary" @click="customdocData.visible=false">录入</el-button> -->
            <div style="float: left; margin-left: 10px;">
              <el-select v-model="queryTempPsntypeParam" slot="prepend" placeholder="请选择" value="" style="width: 150px;">
                  <el-option :label="fObj.label" :value="fObj.value" :key="index" v-for="(fObj , index) in customdocPsnTypeOption"></el-option>
              </el-select>
              <el-button slot="append" icon="el-icon-search" @click="initPageData(pkCustomerSelChange)"></el-button>
            </div>
            <el-row>
              <el-col :span="24">
                <el-card class="box-card">
                  ...
                  <div class="text item">
                    <el-table :data="bdCustomdocPoList" style="width: 100%">
                      ...
                      <el-table-column prop="customtype" label="人员类别" width="100"
                        :formatter="(row, column) => {
                          if (row.customtype == '0') { return '采购联系人' }
                          if (row.customtype == '1') { return '技术联系人' }
                          if (row.customtype == '2') { return '其他人员' }
                        }"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    initPageData(pkCustomerParam) {
      ...
      if (pkCustomerParam) {
        let queryParam = {
          pkCustomer: pkCustomerParam,
          customtype: this.queryTempPsntypeParam
        }
          ...
          if (response.object) {
            ...
            if (customdocList) {
              for (let index in customdocList) {
                ...
                if (this.queryTempPsntypeParam) {
                  if (this.queryTempPsntypeParam === customOne.customtype) {
                    this.bdCustomdocPoList.push(customOne)
                  }
                } else {
                  this.bdCustomdocPoList.push(customOne)
                }
