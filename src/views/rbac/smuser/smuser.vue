  ...
  data() {
    return {
      ...
      columns: [
        ...
        {prop: 'userName', label: '用户名称', width: '80', search: true},
        {prop: 'userCode', label: '用户编码', width: '100'},
        ...
        {prop: 'islocked', label: '是否锁定', width: '90'},
        {prop: 'enablestate', label: '是否启用', width: '90'},
        ...
        {prop: 'creatorShow', label: '创建人', width: '70'},
