  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: "menuName", label: "菜单名称", width: "110", search: true },
        { prop: "menuCode", label: "菜单编码", width: "100" },
        { prop: "icno", label: "图标", width: "100", show: false },
        { prop: "parentId", label: "父级菜单", width: "120", show: false },
        { prop: "url", label: "URL", width: "260" },
        { prop: "sort", label: "排序", width: "50" },
        { prop: "bindBtn", label: "绑定按钮", width: "120", show: false },
        { prop: "creator", label: "创建人", width: "100", show: false },
