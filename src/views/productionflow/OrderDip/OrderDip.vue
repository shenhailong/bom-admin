  ...
  data() {
    return {
      ...
      columns: [
        ...
        // {prop: 'productionState', label: '完工日期', width: '100'},
        // {prop: 'productionState', label: '所用人数', width: '100'},
  ...
  methods: {
    ...
    onButtonClick(param, btnCode, unexParam) {
        ...
        this.$confirm("是否操作该项?", "提示", {
          ...
          .then(() => {
            ...
            if (param.bindData.pkProductOrderB) {
              ...
              dipInspeReportProccess(inspeParam).then((res)=>{
                  this.label(this.ressl)
              })
            }
         ...
         this.$confirm("是否操作该项?", "提示", {
          ...
          .then(() => {
            ...
            if (param.bindData.pkProductOrderB) {
             ...
             updateProductionDip(overParam).then((res)=>{
               this.label(this.ressl)
                // location.reload();
             })
            }
      ...
      if(param.btnCode === "exhibition"){
        ...
        this.$router.push({path:"/hiderouters/exhibition",query:{pkProductOrderB:param.bindData.pkProductOrderB,type:['DIP']}},);
      }
      //查看主题弹窗
