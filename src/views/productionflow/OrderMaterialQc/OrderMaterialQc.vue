...
import {
  selectAllOmgMaterielQualityAsPage,
  updateOmgMaterielQuality,
} from "@/api/orderCompMage/OrderMaterialQc";
...
export default {
  ...
  methods: {
    ...
    onButtonClick(param, btnCode, unexParam) {
      ...
      if (param.btnCode === "OVERMATERIALQC") {
        // 完成质检
            ...
            pkProductOrderB: param.bindData.pkProductOrderB,
              ...
              this.$confirm("是否确认该项?", "提示", {
                ...
                .then(() => {
                  ...
                  updateOmgMaterielQuality(mrpParam)
