      ...
      <el-col :span="24">
        <el-row>
          ...
          <el-col :span="11" class="icon">
            ...
            <i class="el-icon-folder-opened"><span>查看文件</span></i>
            <i class="el-icon-finished"><span>确认标准</span></i>
...
import ProductionFlowOrderAuditFileDetails from "@/views/productionflow/OrderAudit/fileDetails";
...
import { selectAllOrderTechnicsAsPage } from "@/api/orderCompMage/OrderAudit";
import { confirmTechnicsProccess } from "@/api/orderCompMage/orderCompMage";
import {
...
export default {
  name: "ProductionFlowOrderAuditView",
  components: {
    Table,
    CommitDialog,
    ProductionFlowOrderAuditFileDetails,
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: "pkOmgTechnics", label: "工艺审核主表主键", primary: true },
        ...
        { prop: "contractCreationtime", label: "签订日期", width: "130" },
        { prop: "billState", label: "单据状态", width: "100" },
        { prop: "orderMemo", label: "备注", width: "100" },
        { prop: "constractPsnname", label: "销售员", width: "80" },
      ],
      select: {
        select: selectAllOrderTechnicsAsPage,
  ...
  methods: {
    ...
    onButtonClick(param, btnCode, unexParam) {
      ...
      if (param.btnCode === "COMFITETECHNICS") {
        // console.log('s');
        // 确认标准
            ...
            pkProductOrderB: param.bindData.pkProductOrderB,
              ...
              this.$confirm("是否确认该操作?", "提示", {
                ...
                .then(() => {
                  ...
                  confirmTechnicsProccess(confirmParam)
                   .then((res)=>{
                    // this.refreshTableList(this.selectedConstractData)
                     this.label(this.ressl)//刷新页面
                    // location.reload();
                  })
