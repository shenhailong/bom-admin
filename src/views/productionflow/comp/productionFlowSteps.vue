	...
	>
      ...
      <el-timeline>
        <el-timeline-item  icon="el-icon-more" color="#0bbd87" size="large">
            工艺审核
            <br/><br/>
            <el-steps direction="vertical" :space="80"  :active="caseProductionBillState('technicsBillState')" finish-status="success">
        ...
        <el-timeline-item icon="el-icon-more"  color="#0bbd87" size="large">
            生产计划
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('orderPlanBillSate')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            库房备料
            <br/><br/>
            <el-steps direction="vertical" :space="80"  :active="caseProductionBillState('materielWareHuoseBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more"  color="#0bbd87" size="large">
            物料采购
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('materielPurchaseBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            来料质检
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('materielQualityBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            物料入库
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('materielPutinWareBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            SMT生产
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('productionSmtBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            DIP生产
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('productionDipBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
         ...
         <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            三防生产
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('productiondefenseBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            老化，测试生产
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('productionTestBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            成品质检
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('becomeBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            成品入库
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('prduFinishPutinBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
        ...
        <el-timeline-item icon="el-icon-more" color="#0bbd87" size="large">
            成品出库
            <br/><br/>
            <el-steps direction="vertical" :space="80" :active="caseProductionBillState('prduFinishPutoutBillState')" finish-status="success">
                <el-step title="自由态"></el-step>
                <el-step title="进行中"></el-step>
                <el-step title="已完成 "></el-step>
            </el-steps>
            ...
            if (this.productionProccessFlowStates && billStateType) {
                switch (billStateType) {
                    ...
                    case 'productionDipBillState': { // DIP生产
                     ...
                     case 'productionTestBillState': { //测试
                        if (this.productionProccessFlowStates.productionTestBillState == '0') {
                            return 1
                        } else if (this.productionProccessFlowStates.productionTestBillState == '1') {
                            return 2
                        } else if (this.productionProccessFlowStates.productionTestBillState == '2') {
                            return 3
                        }
                    }
                    case 'productiondefenseBillState': { //老化
                        if (this.productionProccessFlowStates.productiondefenseBillState == '0') {
                            return 1
                        } else if (this.productionProccessFlowStates.productiondefenseBillState == '1') {
                            return 2
                        } else if (this.productionProccessFlowStates.productiondefenseBillState == '2') {
                            return 3
                        }
                    }
