      ...
      <el-col :span="24">
        <el-row>
          ...
          <el-col :span="11" class="icon">
            ...
            <i class="el-icon-check"><span>报检</span></i>
...
import ProductionFlowOrderDipContent from "./subinfo/subinfo";
...
import {
  selectAllProductionTestAsPage,
  updateProductionTest,
  testInspeReportProccess,
} from "@/api/ThreePreventions/index"; // 测试借口路径
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { prop: "pkOmgProduTest", label: "DIP主表主键", primary: true },
 ...
 drawers() {
    ...
    onButtonClick(param, btnCode, unexParam) {
        ...
        this.$confirm("是否操作该项?", "提示", {
          ...
          .then(() => {
            ...
            if (param.bindData.pkProductOrderB) {
              ...
              testInspeReportProccess(inspeParam).then((res) => {
                this.label(this.ressl);
              });
            }
      ...
      if (param.btnCode === "OVERDIP") {
        ...
        this.$confirm("是否操作该项?", "提示", {
          ...
          .then(() => {
            ...
            if (param.bindData.pkProductOrderB) {
              let overParam = {
                pkOmgProduTest: param.bindData.pkOmgProduTest,
                billState: "2",
                pkProductOrderB: param.bindData.pkProductOrderB,
              };
              updateProductionTest(overParam).then((res) => {
                this.label(this.ressl);
                // location.reload();
              });
            }
      ...
      if(param.btnCode === "exhibition"){
        ...
        this.$router.push({path:"/hiderouters/exhibition",query:{pkProductOrderB:param.bindData.pkProductOrderB,type:['组装','测试','老化']}},);
      }
      //查看主题弹窗
