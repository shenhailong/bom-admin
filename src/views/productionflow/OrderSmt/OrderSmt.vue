<template>
  <div>
      ...
      <el-col :span="24">
        <el-row>
          ...
          <el-col :span="6" :offset="3">
            <el-tag class="ordre-tag">当前选择订单合同:{{
    ...
    <!--SMT子表展示组件-->
    <ProductionFlowOrderSmtContent :replace="replace" :visiable="content.visiable" :title="content.title"
      :action="content.action" :updateRow="content.updateRow" :pkProductOrder="content.pkProductOrder"
      :selectedConstractData="selectedConstractData" @refreshTableList="refreshTableList" @close="closeContent">
...
<script>
  ...
  import {
    selectAllOmgProductionSmtAsPage,
    updateOmgProductionSmt,
    smtInspeReportProccess
  ...
  export default {
    ...
    data() {
      return {
        ...
        select: {
          select: selectAllOmgProductionSmtAsPage,
    ...
    methods: {
      ...
      onButtonClick(param, btnCode, unexParam) {
        if (param.btnCode === "exhibition") {
          this.$router.push({ path: "/hiderouters/exhibition", query: {pkProductOrderB:param.bindData.pkProductOrderB, type: ['SMT'] } },);
        }
          ...
          this.$confirm("是否操作该项?", "提示", {
            ...
            .then(() => {
              ...
              if (param.bindData.pkProductOrderB) {
                ...
                smtInspeReportProccess(inspeParam).then((res) => {
                  this.label(this.ressl)
                })
              }
          ...
          if (param.bindData.finishNum >= param.bindData.constractProductNum) {
            ...
            this.$confirm("是否操作该项?", "提示", {
              ...
              .then(() => {
                ...
                if (param.bindData.pkProductOrderB) {
                  let overParam = {
                    pkOmgProduSmt: param.bindData.pkOmgProduSmt,
                    billState: "2",
                    pkProductOrderB: param.bindData.pkProductOrderB,
                  };
                  updateOmgProductionSmt(overParam).then((res) => {
