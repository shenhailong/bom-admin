      ...
      <el-col :span="24">
        <el-row>
          ...
          <el-col :span="11" class="icon">
            ...
            <i class="el-icon-check"><span>入库</span></i>
    ...
    onButtonClick(param, btnCode, unexParam) {
      ...
      if (param.btnCode === "BEGINPUTIN") {
        ...
        if (param.bindData.pkProductOrderB) {
          ...
          this.$confirm("此操作将永久入库该文件, 是否继续?", "提示", {
      ...
      if (param.btnCode === "OVERQUALITY") {
        ...
        if (param.bindData.pkOmgBecome) {
          ...
          this.$confirm("此操作将永久出库该采购, 是否继续?", "提示", {
            confirmButtonText: "确定",
            cancelButtonText: "取消",
            type: "warning",
          })
