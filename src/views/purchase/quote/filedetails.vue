<template>
  <el-dialog
    title="工艺文件维护"
    :visible.sync="contentVisiable11"
    @close="closeDialog"
    width="80%"
  >
...
export default {
  ...
  data() {
    return {
      contentVisiable11: false, // dialog 显示框
  ...
  watch: {
    visiable() {
      this.contentVisiable11 = this.visiable;
