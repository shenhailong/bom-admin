...
import { listBdDept, addBdDept, deleteBdDeptdocByPks, updateBdDeptdoc, pullAllDeptByDingDing} from '@/api/orgs/bddept'
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {prop: 'deptshortname', label: '部门简称', width: '80'},
    ...
    onButtonClick(param) { // 监控页面中所有的按钮点击事件
      ...
      if(param.btnCode == 'dd'){
        this.$confirm("你是否确认如上操作?", "提示", {
          ...
          pullAllDeptByDingDing({"pkCorp":2})
        })
