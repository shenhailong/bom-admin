...
import { listBdPsndoc, addBdPsndoc, deleteBdPsndocByPks, updateBdPsndoc,pullAllPsndocByDingDing } from '@/api/orgs/bdpsndoc'
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {prop: 'psnname', label: '人员姓名', width: '80', search: true},
        {prop: 'psncode', label: '人员编码', width: '80'},
        ...
        {prop: 'sealdate', label: '是否封存', width: '80'},
    ...
    onButtonClick(param) { // 监控页面中所有的按钮点击事件
      if (param.btnCode === 'ADD') {
       ...
       if (param.btnCode === 'dd') {
        ...
        pullAllPsndocByDingDing({"pkCorp":2})
          })
      }
