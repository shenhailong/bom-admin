...
<!-- 成品质检 -->
    ...
    >
      ...
      <el-table-column prop="qcState" label="序列号段" width="95"></el-table-column>
      <el-table-column prop="qcExplain" label="报检数量" width="95"></el-table-column>
      <el-table-column prop="filename" label="合格数量" width="95"></el-table-column>
      <el-table-column prop="creator" label="合格率" width="95"></el-table-column>
      <el-table-column prop="creationtime" label="附件名称" width="95"></el-table-column>
