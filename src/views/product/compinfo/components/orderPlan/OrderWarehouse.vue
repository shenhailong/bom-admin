<template>
  ...
  <div>
    <div class="handle-box">
      <div class="listname">
        <el-button type="primary" @click="updateWarehouseState('1')"
          >MPR确认</el-button
        >
      </div>
      <!-- <div class="listname">
    ...
    >
      ...
      <el-table-column prop="whState" label="进度名称" width="110">
        <template slot-scope="scope">
          ...
          <span style="color: green" v-else-if="scope.row.whState == 1"
            >MPR确认</span
          >
          <span style="color: blue" v-else-if="scope.row.whState == 2"
            >物料到货</span
          >
        </template>
      </el-table-column>
      <el-table-column prop="whState" label="状态名称" width="110">
        <template slot-scope="scope">
          <span style="color: green" v-if="scope.row.onOffState == 0"
            >进行中</span
          >
          <span style="color: red" v-else-if="scope.row.onOffState == 1"
            >暂停中</span
          >
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" fixed="right" width="180">
        <template slot-scope="scope">
          <el-button
            size="mini"
            @click="handleEdit(scope.$index, scope.row.pkWarehouse)"
            >下载</el-button
          >
          <el-button
