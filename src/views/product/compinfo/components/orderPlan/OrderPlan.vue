  ...
  <div>
    ...
    <el-dialog :visible.sync="dialogFormVisible" width="700px" append-to-body>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-if="add" type="primary" @click="insertProduction"
          >添加</el-button
        >
        <el-button v-if="alert" type="primary" @click="updateProduction"
          >修改</el-button
        >
