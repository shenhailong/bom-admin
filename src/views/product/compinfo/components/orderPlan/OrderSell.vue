  ...
  <div>
    ...
    <div class="box">
      ...
      <div class="bottom">
        ...
        <span class="right"> 金额：{{ temp.salesAmount }} </span>
      </div>
    </div>
    <el-dialog
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button v-if="add" type="primary" @click="insertSalesLaunchMethod"
          >添加</el-button
        >
        <el-button v-if="alert" type="primary" @click="updateSalesLaunch"
          >修改</el-button
        >
      </span>
    </el-dialog>
