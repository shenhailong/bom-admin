  ...
  <div class="app-container">
    <el-tabs tab-position="top" style="height: 200px">
      ...
      <el-tab-pane label="基本信息">
        <el-button-group>
          <el-button type="primary" @click="viewState.basicInfoState = false"
            >编辑</el-button
          >
          <el-button type="primary" @click="updateCustomerInfo()"
            >保存</el-button
          >
        </el-button-group>
        <hr />
        ...
        >
          ...
          <el-form-item label="联系人姓名" prop="name">
            <el-input
              v-model="bdCustomerPo.name"
              :disabled="viewState.basicInfoState"
            ></el-input>
          </el-form-item>
          <el-form-item label="个人/公司名称" prop="corpname">
            <el-input
              v-model="bdCustomerPo.corpname"
              :disabled="viewState.basicInfoState"
            ></el-input>
          </el-form-item>
          <el-form-item label="公司地址" prop="corpaddress">
            <el-input
              v-model="bdCustomerPo.corpaddress"
              :disabled="viewState.basicInfoState"
            ></el-input>
          </el-form-item>
      ...
      <el-tab-pane label="收货信息">
        <el-button
          class="filter-item"
          type="primary"
          @click="takeOverData.visible = true"
          >录入</el-button
        >
        <hr />
        <el-table :data="bdTakeoverPoList" style="width: 100%">
          ...
          <el-table-column label="操作栏">
            <template slot-scope="scope">
              ...
              <el-button @click="saveTakeOver('del', scope.row)"
                >删除</el-button
              >
            </template>
          </el-table-column>
      ...
      <el-tab-pane label="开票信息">
        <el-button-group>
          <el-button type="primary" @click="viewState.invoiceState = false"
            >编辑</el-button
          >
        ...
        >
          <el-form-item label="开票公司名称" prop="corpname">
            <el-input
              v-model="bdInvoicePo.corpname"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="税号" prop="dutynum">
            <el-input
              v-model="bdInvoicePo.dutynum"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="地址" prop="invoiceAddress">
            <el-input
              v-model="bdInvoicePo.invoiceAddress"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="电话" prop="invoiceTel">
            <el-input
              v-model="bdInvoicePo.invoiceTel"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="开户行" prop="invoiceBank">
            <el-input
              v-model="bdInvoicePo.invoiceBank"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="账号" prop="invoiceAccount">
            <el-input
              v-model="bdInvoicePo.invoiceAccount"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
        </el-form>
        ...
        >
          <el-form-item label="发票收件人" prop="addressee">
            <el-input
              v-model="bdInvoicePo.addressee"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="发票收件人电话" prop="addresseeTel">
            <el-input
              v-model="bdInvoicePo.addresseeTel"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
          <el-form-item label="发票收件人地址" prop="addresseeAdrs">
            <el-input
              v-model="bdInvoicePo.addresseeAdrs"
              :disabled="viewState.invoiceState"
            ></el-input>
          </el-form-item>
        </el-form>
    ...
    <div v-if="takeOverData.visible">
      <el-dialog
        title="详细信息"
        :visible.sync="takeOverData.visible"
        width="1000px"
      >
        <el-form
          :inline="true"
          ref="dataForm"
          :model="takeOverData.temp"
          label-position="left"
          label-width="200px"
        >
          ...
          <el-form-item label="收货人" prop="takeoverPsn">
            <el-select
              v-model="takeOverData.temp.takeoverPsn"
              placeholder="请选择"
              @change="listname"
            >
              <el-option
          ...
          <el-form-item label="联系电话" prop="takeoverTel">
            <el-input
              v-model="takeOverData.temp.takeoverTel"
              :disabled="true"
            ></el-input>
          </el-form-item>
          ...
          <el-form-item label="是否默认" prop="defaultis">
            <el-select
              v-model="takeOverData.temp.defaultis"
              placeholder="请选择"
            >
              <el-option
...
export default {
  ...
  methods: {
    ...
    updateCustomerInfo() {
        ...
        this.$confirm("此操作将永久修改该用户基本信息, 是否继续?", "提示", {
          ...
          .then(() => {
            ...
            updateBdCustomer(this.bdCustomerPo)
            this.initPageData(this.pkCustomer).then((res)=>{
                // location.reload();
            })
      ...
      if ("del" === del) {
        ...
        if (this.pkCustomer) {
          this.takeOverData.temp.pkCustomer = this.pkCustomer;
            ...
            this.initPageData(this.pkCustomer);
            this.takeOverData.visible = false;
            this.$confirm("此操作将永久保存该收货信息, 是否继续?", "提示", {
              confirmButtonText: "确定",
              cancelButtonText: "取消",
              type: "warning",
            })
              .then(() => {
                ...
                saveTakeOver(this.takeOverData.temp).then((res)=>{
                    // location.reload();
                })
    ...
    saveInvoice() {
      ...
      this.bdInvoicePo.pkCustomer = this.pkCustomer;
        ...
        this.initPageData(this.pkCustomer);
        this.$confirm("此操作将永久保存该发票信息, 是否继续?", "提示", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning",
        })
          .then(() => {
            ...
            saveInvoice(this.bdInvoicePo).then((res)=>{
                // location.reload();
            })
