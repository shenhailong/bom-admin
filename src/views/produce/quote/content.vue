    ...
    >
      ...
      <el-tabs type="border-card">
        <el-tab-pane label="基本信息">
          ...
          <!-- 产品类别 -->
          <el-form-item label="产品类别" prop="temp.productType">
            <el-select
              @change="productSelct"
        ...
        <el-tab-pane label="报价信息">
            ...
            >
              <template slot-scope="scope">
                <el-form :model="scope.row" :rules="rules">
                  <el-form-item prop="unitPriceOut">
                    <el-input
                      size="small"
          ...
          <el-table :data="temp.modelQuoteBPoList" show-summary>
            <el-table-column
              ...
              v-if="false"
            ></el-table-column>
            <!-- <el-table-column prop="ismodel"></el-table-column> -->
            <el-table-column
              prop="type"
              label="工序类别"
              width="180"
            ></el-table-column>
            <el-table-column label="制具编号" prop="modelCode" width="80">
              <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.modelCode"></el-input>
              </template>
            </el-table-column>
            <el-table-column label="单价" prop="unitPriceOut" width="180">
              <template slot-scope="scope">
                <el-input
                  size="small"
                  v-model="scope.row.unitPriceOut"
            ...
            <el-table-column label="数量" prop="param" width="80">  
              <template slot-scope="scope">
                <el-input
                  size="small"
          ...
          <el-table :data="temp.specialQuoteBPoList" show-summary>
            ...
            <el-table-column label="单板收费" prop="param" width="80">
              <template slot-scope="scope">
                <el-input
                  size="small"
                  v-model="scope.row.param"
            ...
            <el-table-column label="备注" prop="memo" width="80">
              <template slot-scope="scope">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      psndocOption: [],
      rules: {
        unitPriceOut: [{ validator: validateNameInput, trigger: "blur" }],
      },
    };
  },
  watch: {
