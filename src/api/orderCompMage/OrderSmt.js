...
//proccessMageMentOrderFlowController/smtInspeReportProccess
export function smtInspeReportProccess(data) {
  return request({
      url: '/proccessMageMentOrderFlowController/smtInspeReportProccess',
      method: 'post',
      data
  })
}