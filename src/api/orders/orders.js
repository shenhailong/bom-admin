...
// 查询所有报价信息
export function selectAllProductOrderByPkOrderBId(data) {
  return request({
      url: '/proOrderController/selectAllProductOrderByPkOrderBId',
      method: 'post',
      data
  })
}
...
//确认价格接口
export function updateProductOrderBH(data) {
  return request({
      url: '/proOrderController/updateProductOrderBH',
      method: 'post',
      data
  })
}
...
// 反单 接口
export function insertProductReorder(data) {
  return request({
      url: '/proOrderController/insertProductReorder',
      method: 'post',
      data
  })
}