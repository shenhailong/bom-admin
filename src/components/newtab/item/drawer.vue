<template>
  <el-drawer
    ...
    :size="size"
  >
    <div class="drawerlayoout" v-if="quto == null">
      <div class="listul" style="width: 20%">
        ...
        <div v-for="(item, index) in listdatas" class="list_updata" :key="index">
          ...
          <el-badge
            ...
            class="item"
          >
            <ul @click="controContent(item, index)" ref="lis">
    ...
    <div class="drawerlayoout" v-else>
      <div style="width: 100%">
        <el-tabs v-model="activeName">
          <el-tab-pane label="内容" name="first">
            <information :information="pkProductOrderB" />
